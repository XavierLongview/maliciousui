...
function getFallbackQuestion(): string {
  ...
  //   "Is this address in North America?",
  //   "Is this in a major city?",
  //   "Is this a residential building?",
  //   "Is this near a university?",
  //   "Is this on a main road?",
  //   "Is this in a downtown area?",
  //   "Is this near public transportation?",
  //   "Is this a single-family home?",
  //   "Is this near a park?",
  //   "Is this in a suburban area?",
  //   "Is this in California?",
  //   "Is this in the eastern United States?",
  //   "Is this in a coastal area?",
  //   "Is this near a shopping center?",
  //   "Is this in a rural area?"
  // ]
  // return fallbackQuestions[questionNumber.value % fallbackQuestions.length]
  return ''
}
